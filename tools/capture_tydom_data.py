...
def build_digest_header(mac: str, password: str, nonce: str, host: str, cloud_mode: bool) -> str:
                        ...
                        if data.startswith(b"HTTP/"):
                            ...
                            if body and content_type and "json" in content_type.lower():
                                try:
                                    ...
                                    print(f"⚠️  #{message_count}: {uri or 'unknown'} - Erreur JSON: {e}")
                                except Exception as e:
                                    print(f"⚠️  #{message_count}: {uri or 'unknown'} - Erreur: {e}")
                            elif body:
                                ...
                                print(f"📥 #{message_count}: {uri or 'unknown'} (non-JSON)")
                        else:
